...
function iniciarApp(){
    ...
    seleccionarFecha() // Añade fecha en el objeto cita

    seleccionarHora()//Añade hora en el objetoi ccita
...
function seleccionarServicio(servicio) {
    ...
    //comprobar si fue seleccionado o deseleccionado el servicio
...
function seleccionarFecha() {
    ...
    inputFecha.addEventListener('input', function(e) {
        ...
        if([6, 0].includes(dia)) {
            e.target.value = ''
            mostrarAlerta('El local está cerrado fines de semana', 'error', '.formulario')
    ...
    try {
            ...
            if(resultado.resultado) {
                Swal.fire({
                    icon: 'success',
                    title: 'Cita Creada',
                    text: 'Tu turno se reservo correctamente!',
                    button: 'OK'
                }).then(() => {
                    setTimeout(() => {
            ...
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: 'Hubo un error en el servidor, intenta mas tarde'
